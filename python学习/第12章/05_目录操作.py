...
# result = os.scandir('/Users/wangrumeng/Wrm/Python/gitProjects/python-base/python学习/第12章/')
# for item in result:
#     print('目录' if item.is_dir() else '文件', item.name)

# 9️⃣os.walk(path)：按层级，递归地遍历指定目录下，所有的子目录和文件
result = os.walk('/Users/wangrumeng/Wrm/Python/gitProjects/python-base/python学习/第12章/')
for item in result:
    print(item)
