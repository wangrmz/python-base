...
# from  order import  max_order_amount as max_amt,show_info
# from pay import  wechat_pay ,show_info as show
# print(max_amt)
# show_info()
# print('*' * 20)
# show()
...
# 关于__all__:
# 1.在Python模块中，可通过__all__来控制【from 模块 import *】能导入哪些模块
# 2.__all__的值可以是：列表、元组
# from order import *
#
# # print(max_order_amount) # 会报错
# create_order()
# show_info()
# print('*' * 20)
